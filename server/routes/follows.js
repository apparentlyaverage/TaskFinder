...
// GET /follows/state/:type/:id  →  { following, followers }
...
router.get('/me', async (req, res) => {
  try {
    const [users, businesses] = await Promise.all([
      pool.query(
        `SELECT f.target_id AS user_id, up.display_name, up.avatar_url, f.created_at
      ...
      pool.query(
        `SELECT f.target_id AS business_id, b.name, b.logo_url, b.category, b.status, f.created_at
