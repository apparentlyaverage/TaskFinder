...
> Last updated: 2026-06-28 — *Built the POPIA cookie-consent banner (accept/reject/customise, versioned, re-openable from footer + Cookie Policy) and swept remaining stale copy: Stripe→Paystack and Rhodes-SSO→@ru.ac.za email everywhere (HowItWorks/Features/TrustSafety/Help/escrow modal), dropped the false "(PTY) Ltd registered" claim. Verified in-browser.*
