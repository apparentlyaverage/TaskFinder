...
- **NEXT ACTION:** Confirm with owner the preview fix resolves the "deletes oldest image" report (and which uploader they used). Then await direction — UI redesign **pass 2** vs. **MVP-3 payments** groundwork. Gate stays until 7 July (owner confirmed).
