...
- **NEXT ACTION:** Owner decision — is this a true public launch *now*? If yes, open the `LAUNCH_AT` gate (regular users are still held until 2026-07-07). Otherwise await direction (UI pass 2 vs. payments).
